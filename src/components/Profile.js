  ...
  return (
    <ScrollView>
      <View
        style={[
          {
            marginTop: available.heightStatusBar,
            paddingBottom: 50,
          },
        ]}
      >
        <View style={styles.boxProfile}>
          ...
          <View style={styles.div_1}>
            ...
            <Text style={styles.name}>
              {user === undefined ? null : user.providerData[0].displayName}
            </Text>
          </View>
          <View style={[styles.in4_box, styles.shadowProp]}>
            <View style={styles.border_div}>
              ...
              <TextInput
                ...
                onChangeText={(newValue) => handleEmail(newValue)}
                style={styles.input}
              />
            </View>
            <View style={styles.border_div}>
              ...
              <TextInput
                ...
                onChangeText={(newValue) => handleName(newValue)}
                style={styles.input}
              />
            </View>
            <View style={styles.border_div}>
              ...
              <TextInput
                ...
                value={
                  user === undefined ? null : user.providerData[0].phoneNumber
                }
                onChangeText={(newValue) => handlePhone(newValue)}
                style={styles.input}
              />
            </View>
            <View style={[styles.container_btn_update, styles.shadowProp]}>
              <TouchableOpacity
                style={styles.button_btn_update}
                onPress={updateClick}
              >
                <Text style={[styles.fs_btn, { color: "#32CD32" }]}>
                  UPDATE
                </Text>
                <FontAwesome
                  style={{ fontSize: 18, color: "#32CD32", marginLeft: 10 }}
                  name="edit"
                  size={18}
                  color="black"
                />
